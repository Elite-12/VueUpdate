<template>
  <div class="contact-tab-wrapper">
    <v-tabs v-model="active" slider-color="primary">
      <v-tab v-for="t in tabHead" :key="t.key" ripple class="text-capitalize" :value="t.tab_key">
    ...
    <v-tabs-window v-model="active">
          ...
          <template v-for="(details, index) in clientData.Clients">
            ...
            >
              <v-layout wrap contact-item-info>
                <v-col xs12 lg12 md12 sm-12 text-center>
                  <div class="tab-image">
                ...
                <v-col xs12 lg12 md12 sm-12 text-center pt-0>
                  ...
                  <span class="d-block text-ellipse contact-links font-sm"
                    ><a href="mailto:JerryBRied@jourrapide.com" class="grey--text">{{
                      details.e_mail
                    }}</a></span
                  >
      ...
      <v-tabs-window-item :value="'favourite'">
        ...
        <v-layout row wrap>
          <template v-for="(details, key, index) in clientData.Clients">
            <app-card v-if="details.tag == 'favourite'" colClasses="xl3 lg3 md6 sm6 xs12">
      ...
      <v-tabs-window-item :value="'recently_added'">
        <br />
        <v-layout row wrap>
          <template v-for="(details, key, index) in clientData.Clients">
            <app-card v-if="details.tag == 'recently_added'" colClasses="xl3 lg3 md6 sm6 xs12">
              <v-layout row wrap contact-item-info>
                <v-col xs12 lg12 md12 sm-12 text-center>
                  <div class="tab-image">
                    <img :src="details.image" />
                ...
                <v-col xs12 lg12 md12 sm-12 text-center pt-0>
                  ...
                  <span class="d-block text-ellipse contact-links font-sm"
                    ><a class="grey--text" href="mailto:JerryBRied@jourrapide.com">{{
                      details.e_mail
                    }}</a></span
                  >
                  <span class="d-block contact-links font-sm"
