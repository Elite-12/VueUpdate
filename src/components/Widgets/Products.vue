  ...
  <div>
    <v-layout row wrap>
      <template v-for="(details, index) in products">
        <app-card :id="index" colClasses="xl3 lg3 md6 sm6 xs12">
          <v-layout row wrap contact-item-info>
            <v-col xs12 lg12 md12 sm-12 text-center>
              <div class="tab-image">
                <!-- Redirect to product detail page -->
                <router-link
                  :to="`/${getCurrentAppLayoutHandler() + '/ecommerce/product-detail/' + details.type + '/' + details.id}`"
                >
            ...
            <v-col xs12 lg12 md12 sm-12 pt-0>
