<template>
  <app-card customClasses="product-item" :footer="true">
    ...
    <div class="overlay-wrap pos-relative mb-5">
      ...
      <div
        class="overlay-content primary lighten-2 d-custom-flex justify-center align-items-center"
      >
        <v-btn
    ...
    <div class="product-info">
      ...
      <span class="fs-12 fw-normal grey--text d-block mb-2">{{ data.category }}</span>
