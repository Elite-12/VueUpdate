  ...
  <div>
    ...
    <v-dialog v-model="dialog" max-width="500px" @click:outside="closeDialog">
      <v-card>
        ...
        <v-card-text>
          <v-text-field label="name" v-model="selectedVoucher.name" required></v-text-field>
          <v-row justify="center">
            <v-col cols="12" sm="12" md="12">
              ...
              >
                ...
                <v-date-picker v-model="selectedVoucher.ends" no-title scrollable>
                  <v-spacer></v-spacer>
                  <v-btn text color="primary" @click="menu = false"> Cancel </v-btn>
                  <v-btn text color="primary" @click="$refs.menu.save(selectedVoucher.ends)">
                    OK
                  </v-btn>
                </v-date-picker>
              </v-menu>
          ...
          <v-text-field label="points" v-model="selectedVoucher.points" required></v-text-field>
