<template>
  <div>
    ...
    <v-container fluid pt-0 grid-list-xl>
            ...
            <v-layout row wrap>
              ...
              <v-col xs12 sm12 md12 lg9 pb-0>
                <div class="d-flex search-field-wrap">
                  <div class="w-75">
                    <v-text-field class="pt-0 pr-3" label="Search Projects"> </v-text-field>
                  </div>
                  <div>
      ...
      <v-layout row wrap v-show="selectedView == 'list'">
        <app-card colClasses="xl12 lg12 md12 sm12 xs12" customClasses="mb-0">
