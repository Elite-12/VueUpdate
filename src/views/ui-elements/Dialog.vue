<template>
  <div>
    ...
    <v-container fluid grid-list-xl pt-0>
      <v-layout row wrap>
        <app-card :heading="$t('message.simpleDialogs')" colClasses="lg12">
          <div class="mb-4">
            <p>
              Choosing an option immediately commits the option and closes the menu. Touching
              outside of the dialog, or pressing Back, cancels the action and closes the dialog.
            </p>
          </div>
          ...
          >
            <v-card>
              ...
              <v-card-text>
                <v-btn class="ma-2" color="warning" @click.stop="dialog2 = !dialog2"
                  >Open Dialog 2</v-btn
                >
                <v-tooltip right>
                  <template v-slot:activator="{ props }">
      ...
      <v-layout row wrap>
        <app-card :heading="$t('message.withoutActivator')" colClasses="xs12 md6">
          <div class="mb-4">
            <p>
              If for some reason you are unable to use the activator slot, be sure to add the
              <code>.stop</code> modifier to the event that triggers the dialog.
            </p>
          </div>
        ...
        <app-card :heading="$t('message.scrollable')" colClasses="xs12 md6">
          <div class="mb-4">
