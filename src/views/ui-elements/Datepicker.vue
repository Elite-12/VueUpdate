<template>
  <div>
    ...
    <v-container fluid grid-list-xl pt-0>
      ...
      <v-layout row wrap>
        <app-card :heading="$t('message.datePickersInDialogAndMenu')" colClasses="xs12 md6">
          <v-menu
            ref="menu"
        ...
        <app-card :heading="$t('message.datePickersWithModal')" colClasses="xs12 md6">
          <v-dialog
            ref="dialog"
            v-model="modal"
            :return-value.sync="date"
      ...
      <v-layout row wrap>
        <app-card :heading="$t('message.datePickersFormattingDate')" colClasses="xs12 md6">
          <v-menu
            ref="menu1"
            :close-on-content-click="false"
            v-model="menu1"
