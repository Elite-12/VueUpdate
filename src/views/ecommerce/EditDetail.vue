          ...
          <v-col cols="12" sm="9" md="10" lg="10" class="mx-auto">
            <v-row>
                ...
                <div class="product-images-wrap d-flex">
                  <div class="product-images mr-4">
                    <div
                      ...
                      for="upload"
                      v-for="img in selectedProduct.image_gallery"
                    >
              ...
              <v-col cols="12" sm="12" md="6" lg="6" class="content-wrap pl-md-6">
                <router-link
                  class="pt-4"
                  :to="`/${getCurrentAppLayoutHandler() + '/ecommerce/edit-product'}`"
                >
                ...
                <v-text-field
                  prepend-icon="edit"
                  label="Availablity"
                  v-model="selectedProduct.availablity"
                  required
                ></v-text-field>
                <v-text-field
                  prepend-icon="edit"
                ...
                <v-text-field
                  ...
                  v-model="selectedProduct.features"
                  required
                ></v-text-field>
                <v-text-field
                  prepend-icon="edit"
...
export default {
  ...
  methods: {
    getProductData(event) {
      var allItems = this.productsData.men.concat(
