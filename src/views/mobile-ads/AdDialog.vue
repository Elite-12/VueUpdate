      ...
      <div class="profile-head app-card mb-30">
        <div class="profile-top mt-4">
          <v-img
            ...
            :src="ad.src ? ad.src : 'https://placehold.co/350x150.png'"
            height="200px"
            contain
          >
            <v-card-title>
              ...
              ></v-file-input>
              <v-btn class="mb-30" small color="error" @click.stop="clearImageInput('en')">
                Remove Image
              </v-btn>
            </v-card-title>
          </v-img>
          <v-img
            ...
            :src="ad.src_ar ? ad.src_ar : 'https://placehold.co/350x150.png'"
            height="200px"
            contain
          >
            <v-card-title>
              ...
              ></v-file-input>
              <v-btn class="mb-30" small color="error" @click.stop="clearImageInput('ar')">
                Remove Image
              </v-btn>
            </v-card-title>
          </v-img>
            ...
            <div class="text-center">
              <v-col xs12 sm12 md12 lg12 pb-0>
                <div class="d-flex search-field-wrap justify-center">
                  <div class="w-70">
                    <v-text-field class="pt-0 pr-3" label="Name" v-model="ad.name"> </v-text-field>
...
export default {
  ...
  methods: {
    ...
    clearImageInput(image_lang = 'en') {
      this.changed = true
      if (image_lang === 'en') {
        this.ad.src = 'https://placehold.co/350x150'
        delete this.ad.image
        this.imageFile = null
      } else {
        this.ad.src_ar = 'https://placehold.co/350x150'
