                    ...
                    <tr v-for="resource in Permissions.resources" :key="resource.id">
                      ...
                      <td>
                        <v-switch
                          ...
                          @change="
                            updateAdminPermission($can(VIEW, resource, false), resource, VIEW)
                          "
                        ></v-switch>
                      </td>
                      <td>
                        <v-switch
                          ...
                          :disabled="loading || selectedAdmin.is_super"
                          @change="
                            updateAdminPermission($can(CREATE, resource, false), resource, CREATE)
                          "
                        ></v-switch>
                      </td>
                      <td>
                        <v-switch
                          ...
                          :disabled="loading || selectedAdmin.is_super"
                          @change="
                            updateAdminPermission($can(UPDATE, resource, false), resource, UPDATE)
                          "
                        ></v-switch>
                      </td>
                      <td>
                        <v-switch
                          ...
                          :disabled="loading || selectedAdmin.is_super"
                          @change="
                            updateAdminPermission($can(DELETE, resource, false), resource, DELETE)
                          "
                        ></v-switch>
                      </td>
                    </tr>
...
export default {
  ...
  methods: {
    ...
    updateAdminPermission(flag, resource, action) {
      ...
      if (resource !== ADMIN_RESOURCE_ID || resource !== PERMISSION_RESOURCE_ID)
        permission.country_id = this.selectedCountry.id
